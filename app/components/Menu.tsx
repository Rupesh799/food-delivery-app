...
const MenuBar = () => {
    ...
    return (
        <div>
            ...
            {open && (<div className="w-full bg-primary-primary3 backdrop-blur-sm text-white absolute left-0 top-24 h-[calc(100vh-6rem)] text-2xl flex flex-col justify-center items-center gap-6 z-10">
                {
                    links.map((link)=>(
